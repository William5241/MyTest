//
//  ALStatisticsBase+UICollectionView.m
//  AllinStatistics
//
...
@implementation ALStatisticsBase (UICollectionView)
    ...
    return @{
             ...
             kUICollectionView:@[
                     ...
                     @{
                         ...
                         kEventHandlerBlock: ^(UICollectionView * webview,id delegate) {
                             ...
                             if([delegate conformsToProtocol:@protocol(UICollectionViewDelegate)] &&
                                [delegate respondsToSelector:selector]) {
                                 ...
                                 Method baseTargetMethod = class_getInstanceMethod(class, @selector(ORIGcollectionView:didSelectItemAtIndexPath:));
