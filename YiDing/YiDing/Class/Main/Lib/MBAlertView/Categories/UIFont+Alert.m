...
+(UIFont*)boldSystemFontThatFitsSize:(CGSize)size maxFontSize:(int)max minSize:(int)min text:(NSString*)text
{
    for(int i = max; i > min; i--) {
        ...
        CGSize _size = [text string_sizeWithFontCompatible:font constrainedToSize:CGSizeMake(size.width, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
...
+(UIFont*)systemFontThatFitsSize:(CGSize)size maxFontSize:(int)max minSize:(int)min text:(NSString*)text
{
    for(int i = max; i > min; i--) {
        UIFont *font = [UIFont boldSystemFontOfSize:i];
        CGSize _size = [text string_sizeWithFontCompatible:font constrainedToSize:CGSizeMake(size.width, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    return [UIFont systemFontOfSize:min];
}
